...
class LabAccountDetail extends StatefulWidget {
  final Function? changeView;
  LabAccountDetail({this.changeView});

  @override
  _LabAccountDetailState createState() => _LabAccountDetailState();
}

class _LabAccountDetailState extends State<LabAccountDetail> {
